...
include 'kit-validation.php';
include 'kit-pagination.php';
?>
                    ...
                    <div class="col-md-12">
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                            <div class="form-group">
                                <h2 class="card-title">Lista de kit</h2>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <a class="text-center btn btn-primary " data-bs-toggle="modal" data-bs-target="#kit-add">
                            ...
                            <tr>
                                <td style="width: 5%;">
                                    <div class="d-flex align-items-center">
                                        <h6><?php echo $row["Kid"] ?></h6>
                                    </div>
                                </td>
                                                   
                                <td>
                                    <div class="d-flex align-items-center">
                                        <h6><?php echo $row["Kname"]  ?></h6>
                                    </div>
                                </td>
...
<div class="modal fade" id="kit-add" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Asignación de nueva Kit</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" id="formKitCreate">
                    <div class="card-body">
                        <div class="new-user-info">
                            <div class="row">                               
                                <div class="form-group col-md-12 ">
                                    <div class="form-floating mb-2">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Nombre del Kit" required >
                                        <label for="rename">kit</label>
                                    </div>
                                   
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary" id="submit-kit-add" name="submit-kit-add" >
