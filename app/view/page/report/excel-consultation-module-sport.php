...
if (isset($_GET['moduleId']) && isset($_GET['sportId'])) {

    $module = $_GET['moduleId'];
    $sport  = $_GET['sportId'];

    $data = $consultationController->MSRegisterConsultation($module, $sport);
    $dataM = $consultationController->MSRegisterConsultation($module, $sport);
...
<h3><br> Reporte por <?php echo $Modulo . ' y por deporte de ' .  $Deportes ?> de los cursos vacacionales <?php echo $Year?></h3>
<table border="1">
    <thead>
        <tr>
            <th>REFERENCIA</th>
