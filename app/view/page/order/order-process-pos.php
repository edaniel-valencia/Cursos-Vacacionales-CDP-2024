...
if (isset($_GET["userId"]) || isset($_GET["courseId"]) || isset($_GET["quota_hourId"]) || isset($_GET["discountId"])) {
    ...
    $invoiceData = $invoiceController->getInvoiceDataIdPOS($userId, $courseId, $quota_hourId, $discountId);
    $invoiceController->createInvoicePOS();
    $getPaymentType = $invoiceController->getPaymentType();
    if (!empty($invoiceData)) {
        $invoiceData = $invoiceData[0];
    }

    $discountController = new DiscountController();
    $discounts = $discountController->getDiscountById($discountId);

    if (!empty($discounts) && is_array($discounts)) {
        $discounts = $discounts[0];

        // $Dvalue = $discounts['Dvalue'];
    }

    $courseController = new CourseController();
    $course = $courseController->getCourseQHEById($quota_hourId, $courseId);
    ...
    $ValueDiscount = $discounts['Dvalue'] * $course['CIprice'];
    $ValueDiscount = number_format($ValueDiscount, 2);
    $Total = $Pay - $ValueDiscount;
                        ...
                        <div class="row p-3">
                            ...
                            <div class="col-lg-6 mt-4 mt-lg-0">
                                ...
                                <div class="d-flex   py-2">
                                    <h6 class="text-danger"><?php echo $discounts['Dpercentage'] . '% por ' . $discounts['Ddescription'] ?> <b>1</b> cupo </h6>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="border-bottom mt-4">
                                ...
                                <div class="d-flex justify-content-between mb-4">
                                    <h6>Descuento</h6>
                                    <h6 class="text-success">$<?php echo $ValueDiscount ?></h6>
                                </div>
                            </div>
                            <div class="mt-4">
                                <div class="d-flex justify-content-between mb-4">
                                ...
                                <div class="d-flex">
                                    <a id="place-order" href="#payment" class="btn btn-success rounded-pill d-block mt-3 w-100">Verificar</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="flex-wrap d-flex justify-content-between align-items-center ">
                                        ...
                                        <div class="row">
                                            ...
                                            <a class="btn btn-primary rounded-pill  " href="invoice-data-pos?userId=<?php echo $userId.'&courseId='.$courseId.'&quota_hourId='.$quota_hourId.'&discountId='.$discountId ?>">                       
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="d-flex justify-content-between flex-wrap">
                                    ...
                                    <a id="deliver-address" href="#payment" class="btn btn-primary rounded-pill d-block">Realizar Orden</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="new-user-info">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="row">
                                                <input type="hidden" id="UCid" name="UCid" value="<?php echo $userCId ?>" class="form-control">
                                                <input type="hidden" id="Uid" name="Uid" value="<?php echo $userId ?>" class="form-control">
                                                <input type="hidden" id="Cid" name="Cid" value="<?php echo $courseId ?>" class="form-control">
                                                <input type="hidden" id="QHid" name="QHid" value="<?php echo $quota_hourId ?>" class="form-control">
                                                <input type="hidden" id="Did" name="Did" value="<?php echo $discountId ?>" class="form-control">
                                                <div class="form-group mt-2 ">
                                                    <div class="form-floating form-group">
                                                        <select name="PTid" id="PTid" class="form-control" onchange="togglePaymentFields()">
                                                            <option value="">Selecciona el tipo de pago...</option>
                                                            <?php foreach ($getPaymentType as $PTrow) { ?>
                                                                <option value="<?php echo $PTrow["PTid"]; ?>">
                                                                    <?php echo $PTrow["PTname"] ?>
                                                                </option>
                                                            <?php } ?>
                                                        </select>
                                                        <label for="module">Tipo de Pago</label>

                                                    </div>
                                                    <div class="form-floating">
                                                        <select name="banco_pay" id="banco_pay" class="form-control" oninput="validateFormPay()">
                                                            ...
                                                            <option value="ServiPago">ServiPagos</option>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-floating">
                                                        <input type="text" id="number_pay" name="number_pay" class="form-control" maxlength="15" minlength="3" placeholder="TSoftec" oninput="validateFormPay()">
                                                        <label for="number_pay">Número de comprobante</label>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="form-floating">
                                                        <input type="date" name="date_pay" id="date_pay" class="form-control" placeholder="TSoftec" oninput="validateFormPay()">
                                                ...
                                                <script>
                                                    function togglePaymentFields() {
                                                        var paymentType = document.getElementById('PTid').value;
                                                        var bancoPay = document.getElementById('banco_pay');
                                                        var numberPay = document.getElementById('number_pay');
                                                        var datePay = document.getElementById('date_pay');
                                                        var img = document.getElementById('img');
                                                        var fileUpload = document.getElementById('file-upload');

                                                        if (paymentType === '3') { // Asumiendo que '1' es el ID para "Efectivo"
                                                            bancoPay.disabled = true;
                                                            numberPay.disabled = true;
                                                            datePay.disabled = true;
                                                            img.style.pointerEvents = 'none';
                                                            fileUpload.disabled = true;
                                                        } else {
                                                            bancoPay.disabled = false;
                                                            numberPay.disabled = false;
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex">
                                        <button name="submit-course-pos-pay" id="submit-course-pos-pay" class="btn btn-primary rounded-pill d-block mt-3 w-100">Finalizar Pago</button>
                                    </div>
                                </div>
                            </div>
