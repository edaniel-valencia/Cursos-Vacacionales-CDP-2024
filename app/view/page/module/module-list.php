                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                $Mstart_ = date("d-m-Y", $Mstart);
                                $Mend = strtotime($row["Mend"]);
                                $Mend_ = date("d-m-Y", $Mend);
                                ?>
                                <td style="width: 5%;">
                                    <div class="d-flex align-items-center">
                                        <h6><?php echo $Mstart_ . ' - ' . $Mend_ ?></h6>
                                    </div>
                                </td>
                                <?php
                                $MIstart = strtotime($row["MIstart"]);
                                $MIstart_ = date("d-m-Y", $MIstart);
                                $MIend = strtotime($row["MIend"]);
                                $MIend_ = date("d-m-Y", $MIend);
                                ?>
                                <td style="width: 5%;">
                                    <div class="d-flex align-items-center">
                                        <h6><?php echo $MIstart_ . ' - ' . $MIend_ ?></h6>
                                    </div>
                                </td>
                                <!--  <td style="width: 5%;">
                                    <div class="d-flex align-items-center">
                            ...
                            <div class="row">
                                <div class="form-group text-center  col-md-12">
                                    <div class="profile-img-edit position-relative">
                                        <img src="./../assets/image/avatars/add-banner.jpeg" alt="avatar" id="img" class="theme-color-default-img profile-pic rounded" onclick="document.getElementById('file-upload').click()" width="100%">
                                ...
                                <div class="form-group col-md-6 ">
                                    <div class="form-floating">
                                        <input type="date" class="form-control" id="FIstart" name="FIstart" placeholder="Fecha inicial del modulo" required>
                                        <label for="start">Fecha inicial inscripción </label>
                                    </div>
                                </div>
                                <div class="form-group col-md-6 ">
                                    <div class="form-floating">
                                        <input type="date" class="form-control" id="FIend" name="FIend" placeholder="Fecha final del modulo" required>
                                        <label for="Fend">Fecha final inscripción </label>
                                    </div>
                                </div>
