                ...
                <div class="modal-body">
                    <form method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <div class="form-floating ">
                                    <input type="date" class="form-control text-primary" id="Fend" name="Fend" value="<?php echo $row["Mend"] ?>" placeholder="TSoftec" required oninput="validateFormUpdateModule()">
                                    <label for="Fend">Fecha final</label>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <div class="form-floating ">
                                    <input type="date" class="form-control text-primary" id="FIstart" name="FIstart" value="<?php echo $row["MIstart"] ?>" placeholder="TSoftec" required oninput="validateFormUpdateModule()">
                                    <label for="Fstart">Fecha inicial inscripción</label>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <div class="form-floating ">
                                    <input type="date" class="form-control text-primary" id="FIend" name="FIend" value="<?php echo $row["MIend"] ?>" placeholder="TSoftec" required oninput="validateFormUpdateModule()">
