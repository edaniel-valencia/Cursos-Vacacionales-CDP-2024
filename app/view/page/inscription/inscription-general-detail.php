...
if (isset($_GET["invoiceId"])) {
    ...
    include 'inscription-online-modal.php';
}
?>
                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <div class="d-flex nav nav-pills  text-center profile-tab">
                            <a class=" btn btn-primary rounded-pill" href="inscription-general" data-bs-toggle="tooltip" title="Volver a la informacion anterior">
                                <i class="fa fa-arrow-left" aria-hidden="true"></i>
                            </a>
                            <?php if (in_array('invoice-my-course-print', $rutas)) : ?>
                                &nbsp;
                                <?php if ($data['PSid'] == 3) { ?>
                                    <a class="rounded-pill btn btn-dark" target="_blank" href="view/page/report/comprobante-accountant.php?invoiceId=<?php echo $data['Iid'] ?>" data-bs-toggle="tooltip" title="Imprimir reporte">
                            ...
                            <?php if (in_array('invoice-my-register-delete', $rutas)) : ?>
                                &nbsp;
                                <a class="rounded-pill btn btn-<?php echo $data['PScolor'] ?>" data-bs-toggle="modal" data-bs-target="#invoice-online-status-edit-<?php echo $invoiceId ?>">
