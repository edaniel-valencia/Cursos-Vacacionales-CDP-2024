<!-- <div class="modal fade" id="invoice-online-voucher-edit-<?php echo $invoiceId ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<div class="modal fade" id="invoice-online-status-edit-<?php echo $invoiceId ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary" id="invoice-online-status-update" name="invoice-online-status-update">
                            <i class="fa fa-refresh" aria-hidden="true"></i> Actualizar
                        </button>
                    </div>
                </form>
