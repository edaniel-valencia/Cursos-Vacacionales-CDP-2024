...
include 'inscription-person-pagination.php';
                    ...
                    <div class="col-md-12">
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                            <div class="form-group">
                                <h2 class="card-title">Cursos Presencial</h2>
                            </div>
                            <div class="row">
                                <div class="form-group d-flex col-lg-12">
                                    <div class="d-flex">
                                        <div class=" ">
                                            <a class="text-center btn btn-info  rounded-pill" href="inscription-person">
                            ...
                            <tr>
                                ...
                                <td style="width: 10%;">
                                    <div class="align-items-center">
                                        <h6><a type="button" href="inscription-person-detail?invoiceId=<?php echo $row['Iid'] . '&discountId=' . $row['Did']  . '&courseId=' . $row['Cid'] . '&userId=' . $row['Uid'] ?>" class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i></a></h6></a></h6>
                                    </div>
                                </td>
                            </tr>
                        <?php  }
