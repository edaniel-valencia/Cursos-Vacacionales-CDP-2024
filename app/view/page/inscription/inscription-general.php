...
include 'inscription-general-pagination.php';
                    ...
                    <div class="col-md-12">
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                            ...
                            <div class="form-group">
                                <h2 class="card-title">Cursos Generales</h2>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group d-flex col-lg-12">
                                    <div class="d-flex" style="margin-right: 10px;">
                                        <div class=" ">
                                            <a class="text-center btn btn-primary  rounded-pill" href="inscription-general">
                                                <i class="fa fa-arrow-left" aria-hidden="true"></i>
                                            </a>
                                            <?php if (isset($_GET['Dstart']) && isset($_GET['Dend']) && !empty($_GET['Dstart'])   && isset($_GET['moduleD']) && !empty($_GET['moduleD'])  && !empty($_GET['Dend'])) { ?>
                                                <a class="text-center btn btn-success rounded-pill" href="./view/page/report/excel-pos-accountant-date.php?Dstart=<?php echo $_GET['Dstart'] . '&Dend=' . $_GET['Dend']  . '&moduleD=' . $_GET['moduleD'] . '&userId=' . $userId; ?>">
                                            ...
                                            <?php if (isset($_GET['module']) && !empty($_GET['module'])) { ?>
                                                <a class="text-center btn btn-success rounded-pill" href="./view/page/report/excel-pos-my-accountant-date-module.php?Mname=<?php echo $_GET['module'] . '&userId=' . $userId; ?>">
                                                    <i class="fa fa-download" aria-hidden="true"></i>
                                    ...
                                    <div class="d-flex">
                                        <div class=" ">
                                            <a class="text-center btn btn-info  rounded-pill" href="inscription-general">
                            ...
                            <div class="row justify-content-end">
                                ...
                                <div class="form-group d-flex col-md-5">
                                    <form class="d-flex" method="GET">
                                        <div class="input-group">
                                            <select name="moduleD" id="moduleD" class="form-control" required>
                                                <option value="">Módulos...</option>
                                                <?php foreach ($module as $Mrow) { ?>
                                                    <option value="<?php echo $Mrow["Mid"]; ?>" <?php if (isset($_GET['module']) && $_GET['module'] == $Mrow["Mid"]) echo 'selected'; ?>>
                                                        <?php echo $Mrow["Mname"] . ' - ' . $Mrow["Mdescription"]; ?>
                            ...
                            <div class="container">
                                <div class="d-flex justify-content-center">
                                    <div id="new-section">
                                        <h5>Total Recaudado: <b id="new-total-value"></b></h5>
                                    </div>
                                </div>
                            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <!-- <?php
                                        $Total = $row['CIprice'] - ($row['CIprice'] * $row['Dvalue']);
                                        $TotalFormatted = number_format($Total, 2, '.', '');

                                        ?> 
                                <td style="width: 3%;">
                                    <div class="d-flex align-items-center">
                                        <h6><?php echo $TotalFormatted ?></h6>
                                    </div>
                                </td>
-->
                                ...
                                <td style="width: 10%;">
                                    <div class="align-items-center">
                                        <h6><a type="button" href="inscription-general-detail?invoiceId=<?php echo $row['Iid'] . '&discountId=' . $row['Did']  . '&courseId=' . $row['Cid'] . '&userId=' . $row['Uid'] ?>" class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i></a></h6></a></h6>
                                    </div>
                                </td>
                            </tr>
                        <?php  }
                ...
                <?php } ?>
                <center>
                    <h3>Total Recaudado: <b id="total-value"><?php echo '$' . number_format($TotalInscription, 2); ?></b></h3>
                </center>
