                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <?php
                                        foreach ($statusPay as $sts) {
                                            if ($sts["PSid"] == $statusId) {
                                        ?>
                                                <h4><span class="badge bg-<?php echo $sts['PScolor'] ?>"><?php echo $sts['PSname'] ?></span></h4>
                                        <?php }
                                        } ?>
                          </div>
                        </div>
                        <div class="d-flex nav nav-pills  text-center profile-tab">
                            <a class=" btn btn-primary rounded-pill" href="invoice-my-course" data-bs-toggle="tooltip" title="Volver a la informacion anterior">
                            ...
                            <!-- <?php if (in_array('invoice-my-course-print', $rutas)) : ?>
                                &nbsp;
                                <a class="rounded-pill btn btn-dark" target="_blank" href="view/page/report/comprobante-online.php?invoiceId=<?php echo $data['Iid'] ?>" data-bs-toggle="tooltip" title="Volver a la informacion anterior">
                                    <i class="fa fa-print" aria-hidden="true"></i>
                                </a>
                            <?php endif; ?> -->
                            <?php if (in_array('invoice-my-course-edit', $rutas)) : ?>
                                &nbsp;
                                <a class="rounded-pill btn btn-info " href="invoice-my-course-edit?invoiceId=<?php echo $data['Iid'] ?>" data-bs-toggle="tooltip" title="Volver a la informacion anterior">
