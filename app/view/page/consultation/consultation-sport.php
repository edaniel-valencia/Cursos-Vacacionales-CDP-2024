                                ...
                                <div class="form-group d-flex col-lg-12">
                                    <div class="d-flex">
                                        <div class=" ">
                                            ...
                                            <?php if (isset($_GET['sport']) && !empty($_GET['sport'])) {
                                                $sportId = $_GET['sport'];

                                            ?>

                                                <?php if (in_array('button-excel-sport', $rutas)) : ?>
                                                    <a class="text-center btn btn-success rounded-pill" target="_blank" href="./view/page/report/excel-consultation-sport.php?sportId=<?php echo $sportId . '&Uname=' . $Uname . '&Ulastname=' . $Ulastname; ?>">
                                                        <i class="fa fa-download" aria-hidden="true"></i>
                                                    </a>
                                                <?php endif; ?>
                                                <?php if (in_array('button-excel-sport-value', $rutas)) : ?>
                                                    <a class="text-center btn btn-success rounded-pill" target="_blank" href="./view/page/report/excel-consultation-sport-value.php?sportId=<?php echo $sportId . '&Uname=' . $Uname . '&Ulastname=' . $Ulastname; ?>">
                                                        <i class="fa fa-download" aria-hidden="true"></i>
                                                    </a>
                                                <?php endif; ?>
                                            <?php } ?>
