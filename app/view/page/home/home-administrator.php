        ...
        <div class="col-md-12 col-lg-12">
            ...
            <div class="row">
                    ...
                    <div class="card" data-aos="fade-up" data-aos-delay="50">
                            ...
                            <div class="">
                                <div class="card-header">
                                    <h4 class="card-title">Inscripciones por Módulo</h4>
                                </div>
                                <div class="card-body">
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Inscripciones por Deporte</h4>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Inscripciones por fecha actual (<?php echo date('d-m-Y') ?>)</h4>
                                </div>
                                <div class="card-body">
                ...
                <script>
                    ...
                    const inscriptionsData = sportsDataForToday.map(data => data.TotalInscriptions);
