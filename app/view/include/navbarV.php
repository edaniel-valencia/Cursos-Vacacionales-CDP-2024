        ...
        <a href="home" class="navbar-brand">
            <div class="logo-main">
                <div class="logo-normal">
                    <img src="https://vacacionales.teampichincha.com/assets/image/icons/logo-dorado.png" class="text-center " alt="" width="60px" height="25%">
                </div>
                <div class="logo-mini">
                    <img src="https://vacacionales.teampichincha.com/assets/image/icons/logo-dorado.png" class="text-center " alt="" width="60px" height="25%">
                </div>
            ...
            <h4 class="logo-title">
                <img src="./../assets/image/icons/logo-cdp-letras.png" class="text-center " alt="" width="85px" height="25%">
            </h4>
        </a>
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        ...
        <div class="sidebar-list">
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <?php
                    if (in_array('user-add', $rutas) || in_array('user-list', $rutas) || in_array('user-list-pos', $rutas)) :
                    ?>
                    ...
                    <ul class="sub-nav collapse" id="user" data-bs-parent="#sidebar-menu">
                        ...
                        <?php endif; ?>
                        <?php if (in_array('user-list-pos', $rutas)) : ?>
                            <li class="nav-item <?php echo ($currentPage == 'user-list-pos') ? 'active' : ''; ?>">
                                <a class="nav-link " href="user-list-pos">
                                    <svg width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M16.191 2H7.81C4.77 2 3 3.78 3 6.83V17.16C3 20.26 4.77 22 7.81 22H16.191C19.28 22 21 20.26 21 17.16V6.83C21 3.78 19.28 2 16.191 2Z" fill="currentColor"></path>
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M8.07996 6.6499V6.6599C7.64896 6.6599 7.29996 7.0099 7.29996 7.4399C7.29996 7.8699 7.64896 8.2199 8.07996 8.2199H11.069C11.5 8.2199 11.85 7.8699 11.85 7.4289C11.85 6.9999 11.5 6.6499 11.069 6.6499H8.07996ZM15.92 12.7399H8.07996C7.64896 12.7399 7.29996 12.3899 7.29996 11.9599C7.29996 11.5299 7.64896 11.1789 8.07996 11.1789H15.92C16.35 11.1789 16.7 11.5299 16.7 11.9599C16.7 12.3899 16.35 12.7399 15.92 12.7399ZM15.92 17.3099H8.07996C7.77996 17.3499 7.48996 17.1999 7.32996 16.9499C7.16996 16.6899 7.16996 16.3599 7.32996 16.1099C7.48996 15.8499 7.77996 15.7099 8.07996 15.7399H15.92C16.319 15.7799 16.62 16.1199 16.62 16.5299C16.62 16.9289 16.319 17.2699 15.92 17.3099Z" fill="currentColor"></path>
                                    </svg>
                                    <span class="item-name">Listado POS </span> </a>
                            </li>
                        <?php endif; ?>
                    </ul>
                ...
                <li class="nav-item">
                    <?php
                    if (in_array('pos-my-register', $rutas) || in_array('pos-web', $rutas) || in_array('pos-all-register', $rutas)) :
                    ?>
                    ...
                    <ul class="sub-nav collapse" id="pos" data-bs-parent="#sidebar-menu">
                        <?php if (in_array('pos-all-register', $rutas)) : ?>
                            <li class="nav-item">
                                <a class="nav-link  <?php echo ($currentPage == 'pos-all-register') ? 'active' : ''; ?>" href="pos-all-register">
                                    <i class="icon">
                                        <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="nav-item">
                    <?php
                    if (in_array('inscription-online', $rutas) || in_array('inscription-person', $rutas)) :
                    ?>
                    ...
                    <ul class="sub-nav collapse" id="inscription" data-bs-parent="#sidebar-menu">
                        ...
                        <?php endif; ?>
                        <?php if (in_array('inscription-general', $rutas)) : ?>
                            <li class="nav-item">
                                <a class="nav-link  <?php echo ($currentPage == 'inscription-general') ? 'active' : ''; ?>" href="inscription-general">
                                    <i class="icon">
                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4" d="M12 1.99976C17.515 1.99976 22 6.48576 22 11.9998C22 17.5138 17.515 21.9998 12 21.9998C6.486 21.9998 2 17.5138 2 11.9998C2 6.48576 6.486 1.99976 12 1.99976Z" fill="currentColor"></path>
                                            <path d="M10.5575 7.77917C10.7485 7.77917 10.9405 7.85217 11.0865 7.99817L14.5735 11.4682C14.7145 11.6092 14.7935 11.8002 14.7935 12.0002C14.7935 12.1992 14.7145 12.3902 14.5735 12.5312L11.0865 16.0032C10.7935 16.2952 10.3195 16.2952 10.0265 16.0012C9.73448 15.7072 9.73548 15.2322 10.0285 14.9402L12.9815 12.0002L10.0285 9.06017C9.73548 8.76817 9.73448 8.29417 10.0265 8.00017C10.1725 7.85217 10.3655 7.77917 10.5575 7.77917Z" fill="currentColor"></path>
                                    ...
                                    <span class="item-name">Generales</span>
                                </a>
                            </li>
                        <?php endif; ?>
                    </ul>
                ...
                <li class="nav-item">
                    <?php
                    if (in_array('consultation-sport', $rutas) || in_array('consultation-module-sport-hour', $rutas) || in_array('consultation-module-sport', $rutas)  || in_array('consultation-module', $rutas)) :
                    ?>
                        <a class="nav-link " data-bs-toggle="collapse" href="#consultation" role="button" aria-expanded="false" aria-controls="consultation">
                            <i class="icon">
                                <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <?php endif; ?>
                    <ul class="sub-nav collapse" id="consultation" data-bs-parent="#sidebar-menu">
                        <!-- <?php if (in_array('consultation-module-sport-hour', $rutas)) : ?>
                            <li class="nav-item">
                                <a class="nav-link  <?php echo ($currentPage == 'consultation-module-sport-hour') ? 'active' : ''; ?>" href="consultation-module-sport-hour">
                                    <i class="icon">
                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4" d="M12 1.99976C17.515 1.99976 22 6.48576 22 11.9998C22 17.5138 17.515 21.9998 12 21.9998C6.486 21.9998 2 17.5138 2 11.9998C2 6.48576 6.486 1.99976 12 1.99976Z" fill="currentColor"></path>
                                            <path d="M10.5575 7.77917C10.7485 7.77917 10.9405 7.85217 11.0865 7.99817L14.5735 11.4682C14.7145 11.6092 14.7935 11.8002 14.7935 12.0002C14.7935 12.1992 14.7145 12.3902 14.5735 12.5312L11.0865 16.0032C10.7935 16.2952 10.3195 16.2952 10.0265 16.0012C9.73448 15.7072 9.73548 15.2322 10.0285 14.9402L12.9815 12.0002L10.0285 9.06017C9.73548 8.76817 9.73448 8.29417 10.0265 8.00017C10.1725 7.85217 10.3655 7.77917 10.5575 7.77917Z" fill="currentColor"></path>
                                    ...
                                    <span class="item-name">Mod. Dep. Horario</span>
                                </a>
                            </li>
                        <?php endif; ?> -->
                        <?php if (in_array('consultation-module-sport', $rutas)) : ?>
                            <li class="nav-item">
                                <a class="nav-link  <?php echo ($currentPage == 'consultation-module-sport') ? 'active' : ''; ?>" href="consultation-module-sport">
                                    <i class="icon">
                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4" d="M12 1.99976C17.515 1.99976 22 6.48576 22 11.9998C22 17.5138 17.515 21.9998 12 21.9998C6.486 21.9998 2 17.5138 2 11.9998C2 6.48576 6.486 1.99976 12 1.99976Z" fill="currentColor"></path>
                                            <path d="M10.5575 7.77917C10.7485 7.77917 10.9405 7.85217 11.0865 7.99817L14.5735 11.4682C14.7145 11.6092 14.7935 11.8002 14.7935 12.0002C14.7935 12.1992 14.7145 12.3902 14.5735 12.5312L11.0865 16.0032C10.7935 16.2952 10.3195 16.2952 10.0265 16.0012C9.73448 15.7072 9.73548 15.2322 10.0285 14.9402L12.9815 12.0002L10.0285 9.06017C9.73548 8.76817 9.73448 8.29417 10.0265 8.00017C10.1725 7.85217 10.3655 7.77917 10.5575 7.77917Z" fill="currentColor"></path>
                                    ...
                                    <span class="item-name">Módulo & Deporte</span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if (in_array('consultation-module', $rutas)) : ?>
                            <li class="nav-item">
                                <a class="nav-link  <?php echo ($currentPage == 'consultation-module') ? 'active' : ''; ?>" href="consultation-module">
                                    <i class="icon">
                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4" d="M12 1.99976C17.515 1.99976 22 6.48576 22 11.9998C22 17.5138 17.515 21.9998 12 21.9998C6.486 21.9998 2 17.5138 2 11.9998C2 6.48576 6.486 1.99976 12 1.99976Z" fill="currentColor"></path>
                                            <path d="M10.5575 7.77917C10.7485 7.77917 10.9405 7.85217 11.0865 7.99817L14.5735 11.4682C14.7145 11.6092 14.7935 11.8002 14.7935 12.0002C14.7935 12.1992 14.7145 12.3902 14.5735 12.5312L11.0865 16.0032C10.7935 16.2952 10.3195 16.2952 10.0265 16.0012C9.73448 15.7072 9.73548 15.2322 10.0285 14.9402L12.9815 12.0002L10.0285 9.06017C9.73548 8.76817 9.73448 8.29417 10.0265 8.00017C10.1725 7.85217 10.3655 7.77917 10.5575 7.77917Z" fill="currentColor"></path>
                                    ...
                                    <span class="item-name">Módulo</span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if (in_array('consultation-sport', $rutas)) : ?>
                            <li class="nav-item">
                                <a class="nav-link  <?php echo ($currentPage == 'consultation-sport') ? 'active' : ''; ?>" href="consultation-sport">
                                    <i class="icon">
                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4" d="M12 1.99976C17.515 1.99976 22 6.48576 22 11.9998C22 17.5138 17.515 21.9998 12 21.9998C6.486 21.9998 2 17.5138 2 11.9998C2 6.48576 6.486 1.99976 12 1.99976Z" fill="currentColor"></path>
                                            <path d="M10.5575 7.77917C10.7485 7.77917 10.9405 7.85217 11.0865 7.99817L14.5735 11.4682C14.7145 11.6092 14.7935 11.8002 14.7935 12.0002C14.7935 12.1992 14.7145 12.3902 14.5735 12.5312L11.0865 16.0032C10.7935 16.2952 10.3195 16.2952 10.0265 16.0012C9.73448 15.7072 9.73548 15.2322 10.0285 14.9402L12.9815 12.0002L10.0285 9.06017C9.73548 8.76817 9.73448 8.29417 10.0265 8.00017C10.1725 7.85217 10.3655 7.77917 10.5575 7.77917Z" fill="currentColor"></path>
                        ...
                        <?php if (in_array('consultation-sure', $rutas)) : ?>
                            <li class="nav-item">
                                <a class="nav-link  <?php echo ($currentPage == 'consultation-sure') ? 'active' : ''; ?>" href="consultation-sure">
                                    <i class="icon">
                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4" d="M12 1.99976C17.515 1.99976 22 6.48576 22 11.9998C22 17.5138 17.515 21.9998 12 21.9998C6.486 21.9998 2 17.5138 2 11.9998C2 6.48576 6.486 1.99976 12 1.99976Z" fill="currentColor"></path>
                                            <path d="M10.5575 7.77917C10.7485 7.77917 10.9405 7.85217 11.0865 7.99817L14.5735 11.4682C14.7145 11.6092 14.7935 11.8002 14.7935 12.0002C14.7935 12.1992 14.7145 12.3902 14.5735 12.5312L11.0865 16.0032C10.7935 16.2952 10.3195 16.2952 10.0265 16.0012C9.73448 15.7072 9.73548 15.2322 10.0285 14.9402L12.9815 12.0002L10.0285 9.06017C9.73548 8.76817 9.73448 8.29417 10.0265 8.00017C10.1725 7.85217 10.3655 7.77917 10.5575 7.77917Z" fill="currentColor"></path>
                                    ...
                                    <span class="item-name">Seguro</span>
                                </a>
                            </li>
                        <?php endif; ?>
                ...
                <li class="nav-item">
                    ...
                    <!-- ////////////////////                                               //////////////////// -->
                    <!-- /////////////////////////////////////////////////////////////////////////////////////// -->
                    <!-- <a class="nav-link " aria-current="page" data-bs-toggle="modal" data-bs-target="#inauguracion">
                        <i class="icon">
                            <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="item-name"> Inauguración</span>
                    </a> -->
                    <!-- <a class="nav-link " aria-current="page" data-bs-toggle="modal" data-bs-target="#modulo2">
                        <i class="icon">
                            <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="item-name"> Inscripción Módulo 2</span>
                    </a> -->
                    <!-- <a class="nav-link " aria-current="page" data-bs-toggle="modal" data-bs-target="#kit">
                        <i class="icon">
                            <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4" d="M16.6203 22H7.3797C4.68923 22 2.5 19.8311 2.5 17.1646V11.8354C2.5 9.16894 4.68923 7 7.3797 7H16.6203C19.3108 7 21.5 9.16894 21.5 11.8354V17.1646C21.5 19.8311 19.3108 22 16.6203 22Z" fill="currentColor"></path>
                                <path d="M15.7551 10C15.344 10 15.0103 9.67634 15.0103 9.27754V6.35689C15.0103 4.75111 13.6635 3.44491 12.0089 3.44491C11.2472 3.44491 10.4477 3.7416 9.87861 4.28778C9.30854 4.83588 8.99272 5.56508 8.98974 6.34341V9.27754C8.98974 9.67634 8.65604 10 8.24487 10C7.8337 10 7.5 9.67634 7.5 9.27754V6.35689C7.50497 5.17303 7.97771 4.08067 8.82984 3.26285C9.68098 2.44311 10.7814 2.03179 12.0119 2C14.4849 2 16.5 3.95449 16.5 6.35689V9.27754C16.5 9.67634 16.1663 10 15.7551 10Z" fill="currentColor"></path>
                        ...
                        <span class="item-name"> Retirar KIT</span>
                    </a> -->
                </li>
